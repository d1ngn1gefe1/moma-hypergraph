...
parser.add_argument('--weights', default=[1.0, 1.0, 10.0, 10.0, 1.0], nargs='+', type=float,
                    help='act, sact, ps_aact, pa_aact, actor')
parser.add_argument('--tasks', default=['act', 'sact', 'ps_aact', 'pa_aact', 'actor'], nargs='+', type=str,
